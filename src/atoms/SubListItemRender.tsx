                        ...
                        (dep) => 
                            <li 
                                ...
                                <div className="row justify-content-md-start">
                                    ...
                                    <div className='col-md-auto'>
                                        <span className={style.contextAccordinText} style={{whiteSpace: "nowrap"}}>{truncateMiddle(dep, 57)}</span>
                                    </div>
                                </div>
                            </li>
                        )}
                            ...
                            <button 
                                ...
                                disabled={discovering}>
                                    <IconAtom 
                                        ...
                                        isRounded={false} 
                                    />
                                <span className={style.contextAccordinButton}>Add all in this page</span>
                            </button>
                        </div>
                        <div className="col-md-auto">
                            <button 
                                ...
                                disabled={discovering}>
                                    <IconAtom 
                                        ...
                                        isRounded={false}
                                    />
                                <span className={style.contextAccordinButton}>Add all filtered</span>
                            </button>
                        </div>
                        <div className="col-md-auto">
                            <button 
                                ...
                                disabled={discovering}>
                                    <IconAtom 
                                        ...
                                        isRounded={false}
                                    />
                                <span className={style.contextAccordinButton}>Remove All Subordinate</span>
                            </button>
                        </div>
                    </div>
                </div>
